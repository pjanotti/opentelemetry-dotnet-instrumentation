...
namespace trace {
  ...
  inline WSTRING managed_profiler_full_assembly_version = "OpenTelemetry.AutoInstrumentation.ClrProfiler.Managed, Version=1.24.0.0, Culture=neutral, PublicKeyToken=34b8972644a12429"_W;
